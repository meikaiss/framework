...
import com.android.framework.customview.design.BetterFloatingActionButton;

/**
 * Created by meikai on 16/4/9.
 */
public class BetterFabBehavior extends FloatingActionButton.Behavior{

    public BetterFabBehavior(Context context, AttributeSet attrs) {
        super();
    }
