package com.android.framework.customview.viewgroup.xflowlayout;
...
public class XFlowLayout extends ViewGroup {
    ...
    public XFlowLayout(Context context, AttributeSet attributeSet, int defStyle) {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        TypedArray a = context.obtainStyledAttributes(attributeSet, R.styleable.XFlowLayout);
        try {
            this.config.setOrientation(a.getInteger(R.styleable.XFlowLayout_android_orientation, CommonLogic.HORIZONTAL));
            this.config.setDebugDraw(a.getBoolean(R.styleable.XFlowLayout_debugDraw, false));
            this.config.setWeightDefault(a.getFloat(R.styleable.XFlowLayout_weightDefault, 0.0f));
            this.config.setGravity(a.getInteger(R.styleable.XFlowLayout_android_gravity, Gravity.NO_GRAVITY));
            this.config.setLayoutDirection(a.getInteger(R.styleable.XFlowLayout_layoutDirection, View.LAYOUT_DIRECTION_LOCALE));
            this.config.setMaxFlowLines(a.getInteger(R.styleable.XFlowLayout_maxFlowLines, 0));
        } finally {
            a.recycle();
        }
    }
    ...
    protected void applyPositionsToViews(LineDefinition line) {
